...
9. ## 🚀 How to Run
   1. Open `python/EDA_and_Model_Comparison.ipynb` in Colab or Jupyter Notebook.  
   2. Load the dataset from `data/Bank_Churn.csv`.  
   3. Train and evaluate the models.  
   4. Explore the Power BI dashboard (`Power BI/dashboard.pbix`).  
